...
export default function ProjectsSlider() {
  ...
  const [hasStartedSlider, setHasStartedSlider] = useState(false);
      ...
      gsap.timeline({
        scrollTrigger: {
          ...
          onUpdate(self) {
            ...
            setStartSlider((prev) => (prev === ready ? prev : ready));
            if (ready) setHasStartedSlider(true);
          },
        },
      }).to(
        slider,
  ...
  const activeStaticImage =
    ["/images/home/projectSlider/p1.jpg", "/images/home/projectSlider/p2.jpg", "/images/home/projectSlider/p3.jpg", "/images/home/projectSlider/p4.jpg", "/images/home/projectSlider/p5.jpg"][
      hasStartedSlider ? active : 0
    ];
  ...
  return (
    ...
    >
      <div className="sticky top-0 w-full h-screen overflow-hidden">
        ...
        {/* Keep Swiper mounted after first start for smooth transitions */}
        {hasStartedSlider && (
          <div
            className={`absolute inset-0 transition-opacity duration-300 ${
              startSlider ? "opacity-100" : "opacity-0 pointer-events-none"
            }`}
          >
            <Swiper
            ...
            <SwiperSlide>
              <div className="relative w-full h-full">
                ...
                <div
                  ...
                  className="absolute inset-0 pl-0 md:pl-12 lg:pl-0 xl:pl-0 pt-6 md:pt-12 lg:pt-16 xl:pt-24 pb-38 z-30 transition-all duration-700 caption-container"
                >
        ...
        {/* Static active image/caption layer (visible before slider mode) */}
        <div
          className={`absolute inset-0 transition-opacity duration-300 ${
            startSlider ? "opacity-0 pointer-events-none" : "opacity-100"
          }`}
        >
