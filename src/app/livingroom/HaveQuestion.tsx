...
const faqData = [
  {
    question:
      "What are the best window styles for a living room?",
    answer:
      "Picture windows that offer uninterrupted views and ample natural light, casement windows that offer excellent ventilation and enhanced security, bay windows that offer a stunning focal point and add architectural interest to your exterior, are all excellent choices for a living room. Villa windows and combination windows can also be a great choice. Please visit one of our Signature Studios or talk to one of our highly trained fenestration experts to discuss more options.",
  },
  {
    question: "What are the best doors for living room access?",
    answer:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, suscipit.",
  },
  {
    question: "How do I choose between uPVC and aluminium?",
    answer:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus, laboriosam.",
  },
  {
    question: "How do I know the right style of doors and windows for my living room?",
    answer:
           ...
           <div className="headingOuter w-full left-side-content lg:sticky lg:top-30">
              <div className="headingTitle mb-6 xl:mb-6 px-6 md:px-0 title-section  max-w-xl">
                ...
                <div className="headingSubTitle flex flex-col justify-center w-full">  
                  <p className="mt-3 text-p  text-theme">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                </div>
              </div>     
            </div>  
