...
import OurValues from "@/components/templates/aboutPage/ourstory/ourValues";
import Awardsaccreditations from "@/components/templates/aboutPage/awardsaccreditations";
...
const {
  headingRef: missionVisionHeadingRef,
  sectionRef: missionVisionSectionRef
} = useHeadingAnimation();
    ...
    <section className={`about-page inside-page w-full ${pageBlurClass}`}>
      ...
      <div className="container">
        ...
        <div className="intro-heightlight mx-auto flex flex-col sm:flex-row gap-y-10 gap-x-10 items-start -mt-[60px] rounded-sm bg-white p-6 relative z-20">   
          ...
          {/* LEFT CONTENT */}
          <div className="flex flex-col justify-center w-full sm:w-[60%]">

            <p>
              Fenesta, India’s No:1 windows and doors brand, is part of DCM
              Shriram Group, one of India’s oldest and leading business conglomerates. Established in 1889, the 137-year-old group has an extensive and expanding portfolio of businesses, with an annual turnover of Rs12,741 crores. Fenesta, an innovative, value-added business, specialises in the design, manufacture, and installation of uPVC and aluminium windows and doors, solid-panel doors, and facades. Since 2002, Fenesta has designed and innovated products that make your life easier, brighter, and more comfortable. With a proven track record of over five million installations across more than 900 cities in India and internationally, Fenestra is today India’s largest windows and doors brand. We serve homes, hotels, hospitals, factories, showrooms and academic institutions. Fenesta’s diverse capabilities, deep knowledge of the Indian market and global technologies have not only enabled it to pioneer the uPVC window revolution in India but also to introduce window innovations relevant to the country. Brand Fenesta’s nationwide infrastructure and all-round expertise in design, planning, fabrication, delivery, and installation allow us to offer end-to-end window and door solutions to suit every need.
            </p>

          </div>        

          {/* RIGHT IMAGE */}
          <div className="flex gap-8  lg:justify-end w-full sm:w-[40%]">

            <div
              ref={addToRefs}
              className="overflow-hidden w-[347px] h-[513px] rounded-xl shadow-lg bg-gray-100"
            >
              <Image
                src="/images/about/al-lift-slide-door.png"
                alt=""
                width={340}
                height={512}
