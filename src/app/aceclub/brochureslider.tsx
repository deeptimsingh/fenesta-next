    ...
    <section className="py-16 bg-[#f5f5f5] overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        {/* Navigation Buttons */}
          ...
          {/* Prev Button */}
          <div className="brochure-prev group absolute left-0 top-1/2 -translate-y-1/2 z-20 cursor-pointer w-11 h-11 rounded-full border border-[#d8d8d8] bg-white hover:bg-black transition-all duration-300 flex items-center justify-center">
          ...
          {/* Next Button */}
          <div className="brochure-next group absolute right-0 top-1/2 -translate-y-1/2 z-20 cursor-pointer w-11 h-11 rounded-full border border-[#d8d8d8] bg-white hover:bg-black transition-all duration-300 flex items-center justify-center">
            <svg width="10" height="16" viewBox="0 0 10 16" fill="none">
        ...
        >
          ...
          <SwiperSlide>
            <div className="group">
              ...
              <div className="bg-white border border-[#dddddd] rounded-[10px] p-6 transition-all duration-500 hover:shadow-xl flex items-center">

                <div className="flex items-center justify-center min-h-[200px]">
                  <img
                    src="/images/aceclub/forest-day.png"
                    alt=""
