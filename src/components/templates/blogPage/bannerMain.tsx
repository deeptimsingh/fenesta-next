  ...
  return (
    <section className="relative h-screen max-h-[768px] w-full overflow-hidden flex items-center justify-start">        
        ...
        <div
          ...
          >
            <h1 className="text-white text-h1 leading-none text-theme flex justify-start flex-wrap ">Latest<span className="font-subFont text-corinthiaHeading text-cream leading-none">Blogs</span></h1>
