...
export default function Featureleftimg() {
                ...
                <div className="container-fluid m-auto px-6 md:px-0 relative z-10">
                        <div ref={sectionRef} className="w-full">
                            <div ref={headingRef} className="title-section text-center flex flex-col justify-center w-full max-w-full md:max-w-4xl mx-auto">
                                <h2 className="text-h2 leading-none">Materials that make a <span className="font-subFont text-corinthiaHeading text-brown">difference</span></h2>
                            </div>
                        </div>
                </div>  
                    ...
                    <div className="w-full sm:w-[45%]">
                        ...
                        <div className="mt-8 space-y-5">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Image
                                    src="/images/about/sustainability/recycle.svg"
                                    alt=""
                                    width={40}
                                    height={40}
                                ...
                                Recyclable uPVC and aluminum profiles
                                </p>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                <div className="flex items-center justify-center mt-1">
                                <Image
                                    src="/images/about/sustainability/steel.svg"
                                    alt=""
                                    width={40}
                                    height={40}
                                    className="w-10 h-10 object-contain"
                                ...
                                <p className="font-bold">
                                Steel reinforced frames for long-term stability
                                </p>
                            </div>
