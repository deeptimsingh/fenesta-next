...
export default function BannerMain() {
  ...
  return (
     <section className="relative h-screen max-h-192 w-full overflow-hidden flex items-center justify-start inside-page-banner">        
        ...
        <div className="container relative h-full">          
          <div ref={titleRef} className="absolute inset-0 top-auto bottom-20 sm:bottom-[14vw] xl:bottom-[8vw] z-10 max-w-3xl">
            <h1 className="text-white text-h1 leading-normal flex justify-start flex-wrap gap-2">Our  <span className="font-subFont text-corinthiaHeading text-cream leading-none"> Presence</span></h1>
